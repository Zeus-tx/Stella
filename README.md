...
Can be found on telegram as [Stella](https://t.me/MissStella_bot).
...
Join the [news channel](https://t.me/ZaBotz) if you just want to stay in the loop about new features or
announcements.
...
class Development(Config):
    OWNER_ID = 1880396311  # my telegram ID
    OWNER_USERNAME = "Zeus_of_tg"  # my telegram username
    API_KEY = "your bot api key"  # my api key, as provided by the botfather
    SQLALCHEMY_DATABASE_URI = 'postgresql://username:password@localhost:5432/database'  # sample db credentials
    MESSAGE_DUMP = '-1880396311' # some group chat that your bot is a member of
    USE_MESSAGE_DUMP = True
    SUDO_USERS = [1880396311]  # List of id's for users which have sudo access to the bot.
    LOAD = []
    NO_LOAD = ['translation']
```
